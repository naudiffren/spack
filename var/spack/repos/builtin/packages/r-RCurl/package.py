...
class RRcurl(Package):
    ...
    homepage = "http://www.omegahat.net/RCurl"
    url = "https://cran.r-project.org/src/contrib/RCurl_1.95-4.8.tar.gz"

    version('1.95-4', '9c8aaff986eb2792c89dd3ae54d21580')
