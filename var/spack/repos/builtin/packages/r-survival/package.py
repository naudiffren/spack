...
class RSurvival(Package):
    ...
    homepage = "https://cran.r-project.org/web/packages/survival/index.html"
    url = "https://cran.r-project.org/src/contrib/survival_2.39-4.tar.gz"

    version('2.39-4', '9b573e282f3fe1da1e8780105e953dc3')
